...
<li><a href="view_aps_transmittal.php"><em class="fa fa-envelope-open-o"></em>View Transmittal Form</a></li>
    ...
    <form method="post" action="bills_form_view_sr.php">
        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block">
              <?php 
              $query=mysqli_query($con, "SELECT * from bills_form_tb");
               $query1=mysqli_query($con, "SELECT SUM(payment) as total_payment from bills_form_tb");
              ?>
              <table>
                <thead>
                  <tr>
