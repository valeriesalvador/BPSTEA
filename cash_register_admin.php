...
<div class="card-block">
             <a href="cash_register_admin.php">Cash Register</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="disbursement_admin.php">Disbursement</a>
             <br><br>
              <h5 class="mt-2">Cash In
    </h5>
    <table>
      <tr>
        <td>
          <a href="over_the_counter_payment_cr_admin.php" class="black">Over the Counter Payments</a></td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <td><span class="red">Total Amount:
      <?php
       $date_today=date('Y-m-d');
       $query3=mysqli_query($con, "SELECT SUM(amount) as total_amount from loan_payment_tb where payment_date='$date_today'");
      ...
      <tr>
          <td>
          <a href="mas_payment_cr_admin.php" class="black">MAS Payments</a></td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <td> <span class="red">Total Amount:
      <?php
       $date_today=date('Y-m-d');
       $payment_for="Mutual Aid System";
       $query3=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where year='$date_today' and payment_for='$payment_for'");
       while ($row=mysqli_fetch_array($query3)) {
         echo "P" .$row['total_amount'];
       }
      ?>
      ...
      <tr>
          <td>
          <a href="annual_due_payment_cr_admin.php" class="black">Annual Dues Payments</a> </td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <td> <span class="red">Total Amount:
      <?php
       $date_today=date('Y-m-d');
       $payment_for="Annual Dues";
       $query4=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where year='$date_today' and payment_for='$payment_for'");
      ...
      ?>
       ...
       <tr>
          <td>
          <a href="membership_fee_payment_cr_admin.php" class="black">Membership Fee Payments</a> </td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <td> <span class="red">Total Amount:
      <?php
       $date_today=date('Y-m-d');
       $payment_for="Membership Fee";
       $query5=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where year='$date_today' and payment_for='$payment_for'");
       if (! $query5) {
      ...
      <tr>
          <td>
          <a href="or_payment_cr_admin.php" class="black">Official Receipt Payments</a> </td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <td> <span class="red">Total Amount:
      <?php
       $date_today=date('Y-m-d');
       $query6=mysqli_query($con, "SELECT SUM(payment) as total_amount from or_tb where or_date='$date_today'");
       if (! $query6) {
         echo mysqli_error($con);
       }
      ...
      ?>
       ...
       <tr>
          <td>
            <span class="reds">
         Total Cash Register Amount:
         <?php
         $date_today=date('Y-m-d');
         $payment_for="Mutual Aid System";
         $payment_for1="Annual Dues";
         $payment_for2="Membership Fee";

          $sql=mysqli_query($con, "SELECT SUM(amount) as total_amount from loan_payment_tb where payment_date='$date_today'");
           $sql1=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where year='$date_today' and payment_for='$payment_for'");
            $sql2=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where year='$date_today' and payment_for='$payment_for1'");
              $sql3=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where year='$date_today' and payment_for='$payment_for2'");
               $sql4=mysqli_query($con, "SELECT SUM(payment) as total_amount from or_tb where or_date='$date_today'");
               while ($r=mysqli_fetch_array($sql)) {
                 while ($r1=mysqli_fetch_array($sql1)) {
                   while ($r2=mysqli_fetch_array($sql2)) {
                     while ($r3=mysqli_fetch_array($sql3)) {
                       while ($r4=mysqli_fetch_array($sql4)) {
                         $total_amount= $r['total_amount'] + $r1['total_amount'] + $r2['total_amount'] + $r3['total_amount'] + $r4['total_amount'];
                         echo "P" . $total_amount . ".00";
                       }
                     }
                   }
                 }
