        ...
        <div class="column">
          <div class="card">
              <div class="card-block" style="overflow-x: scroll;">
                  ...
                  <a href="annual_dues_amount_maintenance.php">Annual Dues Amount</a>&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="membership_fee_maintenance.php">Membership Fees Amount</a>&nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="mutual_aid_system_maintenance.php">Mutual Aid System Amount</a>
              ...
              <form method="post" action="annual_dues_amount_maintenance_action.php">
              
                <fieldset>
              Annual Dues Payment<br>
                   
                   <label for="nameField">Old Member's Annual Dues Amount</label>
                  <input type="number" placeholder="Old Member's Annual Dues Amount" value="<?php echo $row['old_annual_due'] ?>" name="old_annual_due" id="nameField" required="">
                      <label for="nameField">New Member's Annual Dues Amount</label>
                  <input type="number" placeholder="New Member's Annual Dues Amount" name="new_annual_due" value="<?php echo $row['new_annual_due'] ?>" id="nameField" required="">
                  </div>

                  <br>
                  <input class="button-primary" type="submit" value="Update Annual Dues Amount">
              ...
              Annual Dues Payment<br>
                   ...
                   <label for="nameField">Old Member's Annual Dues Amount</label>
                  <input type="number" placeholder="Old Member's Annual Dues Amount"  name="old_annual_due" id="nameField" required="">
                      <label for="nameField">New Member's Annual Dues Amount</label>
                  <input type="number" placeholder="New Member's Annual Dues Amount" name="new_annual_due"  id="nameField" required="">
                  </div>
