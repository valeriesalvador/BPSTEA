...
<body>
  ...
  <br>
    ...
    <form method="post" action="bills_form_view_admin_sr.php">
        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block">
              ...
              $query1=mysqli_query($con, "SELECT SUM(payment) as total_payment from bills_form_tb where payment LIKE '%$search_query%' or payment_for LIKE '%$search_query%'")
              ?>
              <table>
                <thead>
                  <tr>
