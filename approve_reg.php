        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block">
              <?php 
              $status="Not Verified";
              $query=mysqli_query($con, "SELECT * from members_tb where status='$status' ORDER BY date_of_membership");
              ?>
              <table>
                <thead>
                  <tr>
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ?>
                     <tr>
                    <td><a href="approve_action.php?id=<?php echo $row['employee_number'] ?>">Approve</a></td>
