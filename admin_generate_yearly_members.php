...
<body>
  ...
  <div class="top-panel">
    <form action="admin_generate_yearly_members.php" method="post">
      Input Year:<input type="number" name="date_from" onKeyPress="return check(event,value)" onInput="checkLength()" id="txtF" required>
...
<br><br>
        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block">
              <?php 
              $status="Not Verified";
              $week=$_POST['date_from'];
              $query=mysqli_query($con, "SELECT * from members_tb where status!='$status' and DATE_FORMAT(date_of_membership, '%Y')='$week' ORDER BY date_of_membership");
    ...
    <td><?php echo $row['date_of_membership'] ?></td>
               ...
               <?php
                ...
                ?>
                  ...
                  echo "No New Members This Year. Please select on dates above to generate reports.";
                }
              ?>
    ...
    $('input[name="date_from"]').keypress(function() {
