...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script><!-- Main Styles -->
<style type="text/css">
	body {
  background: #f9f9f9;
  height: 100%;
    ...
    <div class="dropdown-content">
      ...
      <a href="balance_sheet_admin.php"><em class="fa fa-envelope-open-o"></em>Balance Sheet</a>
       <a href="income_statements_admin.php"><em class="fa fa-envelope-open-o"></em>Income Statements</a>
        ...
        <div class="btn-group">
        <button type="button" style="background-color: red; color:white;font-style:bold;font-size:18px;" data-toggle="dropdown">Filter By: <span class="caret"></span></button>
        <ul class="dropdown-menu">
          <li><a  href="old_members.php">Old Members</a></li>
          <li><a href="new_members.php">New Members</a></li>          
      <li><a href="aps_members.php">APS Members</a></li>             
       <li><a href="otc_members.php">Over the Counter Members</a></li>             
        </ul>
      </div>
    </div>
    <h5 class="mt-2">List of Registered Members</h5><a class="anchor" name="tables"></a>   <form method="post" action="search_results.php">
...
<div class="card-block">
              ...
              $query=mysqli_query($con, "SELECT * from members_tb where status!='$status' and status!='Cashier' and status!='Book Keeper' ORDER BY date_of_membership");
              ?>
              <table>
                <thead>
                  <tr>
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ?>
                    ...
                    <td><?php echo $row['birthday']; ?></td>
                     ...
                     <td><a href="view_more_details_trans.php?id=<?php echo $row['employee_number'] ?>">View More Details and Transactions History</a></td>
