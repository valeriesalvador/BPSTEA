...
<body>
  ...
  <div class="top-panel">
    <form action="admin_generate_monthly_members.php" method="post">
      Select Month and Year:<input type="month" name="date_from" required>
        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block">
              <?php 
              $status="Not Verified";
              $week=date_create($_POST['date_from']);
              $week1=date_format($week, 'Ym');
              $query=mysqli_query($con, "SELECT * from members_tb where status!='$status' and DATE_FORMAT(date_of_membership, '%Y%m')='$week1' ORDER BY date_of_membership");
              if (! $query) {
    ...
    <td><?php echo $row['date_of_membership'] ?></td>
               ...
               <?php
                ...
                ?>
                  ...
                  echo "No New Members This Month. Please select on dates above to generate reports.";
                }
              ?>
