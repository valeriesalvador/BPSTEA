...
<body>
  ...
  <br>
    ...
    <div class="dropdown-content">
      ...
      <a href="create_account_employees.php"><em class="fa fa-envelope-open-o"></em>Create Account for Employees</a>
    </div>
  </li>
      </ul>
    </div>
  ...
  <div class="top-panel">
    <form action="admin_generate_weekly_members.php" method="post">
      Select Date From:<input type="date" name="date_from" required> To: <input type="date" name="date_to" required>
      <input type="submit" value="Generate Member's Report">
    </form>
      <div class="btn-group">
      ...
      <li><a class="export" data-export-type="txt">TXT</a></li>             
       ...
       <div class="btn-group">
        ...
        <ul class="dropdown-menu">
          <li><a  href="member_reports_admin_weekly.php">Weekly</a></li>
          <li><a href="member_reports_admin_monthly.php">Monthly</a></li>          
      <li><a href="member_reports_admin_yearly.php">Yearly</a></li>             
        </ul>
      </div>
    </div>
<br><br>
        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block">
              ...
              $date_from1=date_format($date_from, 'Y-m-d');
              $date_to=date_create($_POST['date_to']);
              $date_to1=date_format($date_to, 'Y-m-d');
              $query=mysqli_query($con, "SELECT * from members_tb where status!='$status' and date_of_membership BETWEEN '$date_from1' and '$date_to1' ORDER BY date_of_membership");
    ...
    <td><?php echo $row['date_of_membership'] ?></td>
               ...
               <?php
                ...
                ?>
                  ...
                  echo "No New Members This Week. Please select on dates above to generate reports.";
                }
              ?>
