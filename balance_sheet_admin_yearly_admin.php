...
<div class="card-block">
   <input name="b_print" type="button" class="ipt"   onClick="printdiv('div_print');" value=" Print ">
              ...
              <table>
                <tr class="header" id="haa">
                  <td>
                    ...
                    Statement of Financial Condition As Of <?php echo $_POST['search_year'] ?>
                  </td>
                </tr>
                <tr>
                  <td>
                    <table>
                      ...
                      <tr>
                       ...
                       <td>
                         ...
                         $query=mysqli_query($con, "SELECT SUM(amount) as total_amount from loan_payment_tb where DATE_FORMAT(payment_date, '%Y')='$year'");
                         if (! $query) {
                           echo mysqli_error($con);
                         }
                         $query1=mysqli_query($con, "SELECT SUM(payment) as total_amount from asset_purchase_form where DATE_FORMAT(date_made, '%Y')='$year' and status='$status'");
                         $query2=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$year' and payment_for='$payment_for'");
                           $query3=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$year' and payment_for='$payment_for1'");
                             $query4=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$year' and payment_for='$payment_for2'");
                       ...
                       $c_total_amount1="";
                        ...
                        $sql=mysqli_query($con, "SELECT SUM(amount) as total_amount from employees_payroll_tb where DATE_FORMAT(payroll_date, '%Y')='$date'");
                       ...
                       $l_total_amount="";
                        ...
                        $status="Approved";
                        $status1="Completed";
                        $sql=mysqli_query($con, "SELECT SUM(loan_amount) as total_amount from loan_tb where DATE_FORMAT(date_approved, '%Y')='$date' and status='$status' and status='$status1'");
                        while ($row=mysqli_fetch_array($sql)) {
                      ...
                      <tr>
                       ...
                       <td>
                        ...
                        $payment_for1="Annual Dues";
                        $payment_for2="Mutual Aid System";
                        $query=mysqli_query($con, "SELECT SUM(amount) as total_amount from loan_payment_tb where DATE_FORMAT(payment_date, '%Y')='$date'");
                         $query1=mysqli_query($con, "SELECT SUM(payment) as total_amount from asset_purchase_form where DATE_FORMAT(date_made, '%Y')='$date' and status='$status'");
                          $query2=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date' and payment_for='$payment_for'");
                           $query3=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date' and payment_for='$payment_for1'");
                            $query4=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date' and payment_for='$payment_for2'");
                               $sql=mysqli_query($con, "SELECT SUM(amount) as total_amount from employees_payroll_tb where DATE_FORMAT(payroll_date, '%Y')='$date'");
                               $sql1=mysqli_query($con, "SELECT SUM(loan_amount) as total_amount from loan_tb where DATE_FORMAT(date_approved, '%Y')='$date' and status='$status' and status='$status1'");
                      ...
                      <tr>
                       ...
                       $of_total_amount1="";
                        ...
                        $status="Approved";
                        $status1="Completed";
                        $sql=mysqli_query($con, "SELECT SUM(payment) as total_amount from asset_purchase_form where DATE_FORMAT(date_made, '%Y')='$date'");
                        while ($row=mysqli_fetch_array($sql)) {
                      ...
                      <tr>
                          ...
                          $query2=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date' and payment_for='$payment_for'");
                           $query3=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date' and payment_for='$payment_for1'");
                            $query4=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date' and payment_for='$payment_for2'");
                               $sql=mysqli_query($con, "SELECT SUM(amount) as total_amount from employees_payroll_tb where DATE_FORMAT(payroll_date, '%Y')='$date'");
                               $sql1=mysqli_query($con, "SELECT SUM(loan_amount) as total_amount from loan_tb where DATE_FORMAT(date_approved, '%Y')='$date' and status='$status' and status='$status1'");
                               $sql2=mysqli_query($con, "SELECT SUM(payment) as total_amount from asset_purchase_form where DATE_FORMAT(date_made, '%Y')='$date'");
                               while ($r=mysqli_fetch_array($query)) {
                                 while ($r1=mysqli_fetch_array($query1)) {
                                    while ($r2=mysqli_fetch_array($query2)) {
                                      while ($r3=mysqli_fetch_array($query3)) {
                       ...
                       $m_total_amount="";
                       $m_total_amount1="";
                        $date_today=$_POST['search_year'];
       $payment_for="Membership Fee";
       $query5=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date_today' and payment_for='$payment_for'");
       if (! $query5) {
         echo mysqli_error($con);
       }
       while ($row=mysqli_fetch_array($query5)) {
        $m_total_amount=$row['total_amount'];
         echo "P" .$row['total_amount'];
                        ...
                        ?></td>
                       <td> <?php
                        $date_today=$_POST['search_year']-1;
       $payment_for="Membership Fee";
       $query5=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date_today' and payment_for='$payment_for'");
       if (! $query5) {
         echo mysqli_error($con);
       ...
       $query6=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$date_today' and payment_for='$payment_for1'");
       if (! $query5) {
         echo mysqli_error($con);
       }
       while ($row=mysqli_fetch_array($query5)) {
