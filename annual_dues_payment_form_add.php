      ...
      <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
              ...
              <form method="post" action="annual_dues_payment_form_add_action.php">
              
                <fieldset>
            
                   <label for="nameField">Member Id</label>
                  <input type="text" value="<?php echo $_GET['id'] ?>" name="member_id" id="nameField" required="">
                  <label for="nameField">Member Id</label>
                  <select name="payment_for" id="nameField" required>
                    <option value="Mutual Aid System">Mutual Aid System</option>
                       <option value="Membership Fee">Membership Fee</option>
                          <option value="Annual Dues">Annual Dues</option>
                  </select>
                    <label for="nameField">Payment Amount</label>
                  <input type="number" value="<?php echo $_GET['id1'] ?>" name="amount" id="nameField" required=""><br>

                  <input class="button-primary" type="submit" value="Add Payment">
