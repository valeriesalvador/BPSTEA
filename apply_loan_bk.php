...
<body>
  <div class="navbar">
   <div class="row">
      <div class="column column-30 col-site-title"><a href="bookkeeper_dashboard.php" class="site-title float-left"><img src="logo1.png" class="logo"></a></div>
  ...
  <div class="row">
   ...
   <ul>
         <li><a href="bookkeeper_dashboard.php"><em class="fa fa-home"></em>Home</a></li>
<li><a href="reg_members_bk.php"><em class="fa fa-address-book-o"></em>Member's Details and Transaction History</a></li>
<li><a href="or_p_bk.php"><em class="fa fa-envelope-open-o"></em>Official Receipts Form</a></li>
            <li><a href="bills_form_bk.php"><em class="fa fa-envelope-open-o"></em>Bills Form</a></li>
             <li><a href="asset_purchase_form_bk.php"><em class="fa fa-envelope-open-o"></em>Asset Purchase Form</a></li>
              <li><a href="loan_reports_bk.php"><em class="fa fa-envelope-open-o"></em>Loan Status Report</a></li>
      </ul>
    </div>
      ...
      <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
              ...
              <form method="post" action="apply_loan_action_bk.php">
