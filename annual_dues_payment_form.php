      ...
      <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
              ...
              <form method="post" action="search_member_annual_dues_payment_form.php">
              
                <fieldset>
            
                   <label for="nameField">Enter Member Id or Full Name</label>
                  <input type="text" placeholder="Enter Member Id" name="search_query" id="nameField" required="">
                    
                  <input class="button-primary" type="submit" value="Search Member">
