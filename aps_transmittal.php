        ...
        <div class="column ">
          <div class="card">
              ...
              <table class="loan_report" id="data_table">
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ?>
                     <tr onclick="window.document.location='aps_transmittal_form.php?id=<?php echo $row['loan_id'] ?>';">
