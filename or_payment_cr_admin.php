...
<div class="card-block">
    ...
    <h5 class="mt-2">Official Receipts Today &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="red">Total Amount:
      <?php
      ...
      ?>
             ...
             <?php
             $date_today=date('Y-m-d');
               $query=mysqli_query($con, "SELECT * from or_tb where or_date='$date_today'");
              $query1=mysqli_query($con, "SELECT SUM(payment) as total_payment from or_tb where or_date='$date_today'");
