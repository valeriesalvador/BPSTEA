...
<li><a href="asset_purchase_form.php"><em class="fa fa-envelope-open-o"></em>Asset Purchase Form</a></li>
    ...
    <section id="main-content" class="column column-offset-20">
       <h5 class="mt-2">Add Co-Maker</h5><a class="anchor" name="forms"></a>
          <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
           
              <div class="card-block">
              <form method="post" action="add_co_maker_action_m.php" enctype="multipart/form-data">
                <fieldset>
                  
                  Co-Maker Details<br>
                   <label for="nameField">Full Name of Co-Maker</label>
                  <input type="text" placeholder="Full Name of Co-Maker" name="full_name" id="nameField" required="">
                  ...
                  <input type="number" placeholder="Age" name="age" id="nameField" required="">
                  ...
                  <br>
                  <input class="button-primary" type="submit" value="Add Co-Maker">
                </fieldset>
              </form>
            </div>
          </div>
