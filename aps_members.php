...
<body>
  ...
  <br>
    ...
    <div class="dropdown-content">
      ...
      <a href="loan_reports_admin.php"><em class="fa fa-envelope-open-o"></em>Loan Status Reports</a>
        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block" style="overflow-x: scroll;">
              ...
              $membership="Automatic Payroll System";
              $query=mysqli_query($con, "SELECT * from members_tb where status!='$status' and status!='$cashier' and status!='$book_keeper' and payment_process='$membership' ORDER BY date_of_membership");
              if (! $query) {
