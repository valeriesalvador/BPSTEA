...
<li><a href="reg_members_bk.php"><em class="fa fa-address-book-o"></em>Member's Details and Transaction History</a></li>
 <li class="dropdown"><a href="javascript:void(0)" class="dropbtn"><em class="fa fa-envelope-open-o"></em>Forms</a>
    ...
    <h5 class="mt-2">List of Official Receipts</h5><a class="anchor" name="tables"></a>
    <form method="post" action="official_receipts_bk.php">
          <input type="text" placeholder="Search By Employee Name/Payment Amount/Payment For/Check Number" name="search_query">
        </form>
...
function str_replace_last( $search , $replace , $str ) {
    ...
    return $str;
              ...
              $query=mysqli_query($con, "SELECT * from or_tb");
              $query1=mysqli_query($con, "SELECT SUM(payment) as total_payment from or_tb");
              ...
              <table>
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ?>
                    ...
                    <td><?php echo "P" . $row['payment']. ".00"; ?></td>
                    <td><?php echo $row['as_payment_for']; ?></td>
                    <td><?php echo "P" . $row['cash']. ".00"; ?>
                      <br>
                      (<?php echo number_to_word($row['cash']) ?>)
                    </td>
                  ...
                  while ($row=mysqli_fetch_array($query1)) {
                    echo "Total Payment: P" . $row['total_payment'] . ".00";
                  }
                   ?>
