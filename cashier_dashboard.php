...
if ($day=="10") {
  $sq=mysqli_query($con, "SELECT * from employees_payroll_tb where payroll_date='$date_today'");
  if (mysqli_num_rows($sq)>0) {
    
  }else{
  $sql=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Danilo T. Banal', '1000', '$date_today')");
  $sql1=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Marites E. Gallezo', '500', '$date_today')");
  $sql2=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Jose Raoul Navata', '500', '$date_today')");
  $sql3=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Carmelita F. Liamzon', '500', '$date_today')");
  $sql4=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Olivia Lumbre', '250', '$date_today')");
   $sql5=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Walter Bantay', '250', '$date_today')");
    $sql6=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Marites Bantugan', '250', '$date_today')");
     $sql7=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Hermogenes G. Albelda', '250', '$date_today')");
      $sql8=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Gloria Crisostomo', '250', '$date_today')");
       $sql9=mysqli_query($con, "INSERT into employees_payroll_tb(designation, amount, payroll_date) values('Menadro Reyes', '250', '$date_today')");
}
}
?>
...
<body>
  <div class="navbar">
   <div class="row">
      <div class="column column-30 col-site-title"><a href="cashier_dashboard.php" class="site-title float-left"><img src="logo1.png" class="logo"></a></div>
     <div class="column column-40 col-search">
        ...
        &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
        <a href="notify_annual.php">Notify Members for Annual Dues</a>
  ...
  <div class="row">
   ...
   <ul>
         <li><a href="cashier_dashboard.php"><em class="fa fa-home"></em>Home</a></li>
<li><a href="or_p.php"><em class="fa fa-thumbs-o-up"></em>Create Official Receipts for Payment</a></li>
<li><a href="official_receipts.php"><em class="fa fa-envelope-open-o"></em>View Official Receipts for Payment</a></li>
<li><a href="bills_form.php"><em class="fa fa-envelope-open-o"></em>Bills Form</a></li>
<li><a href="asset_purchase_form.php"><em class="fa fa-envelope-open-o"></em>Asset Purchase Form</a></li>
<li><a href="otc_loan.php"><em class="fa fa-envelope-open-o"></em>Over the Counter Loan Payment</a></li>
<li><a href="aps_transmittal.php"><em class="fa fa-envelope-open-o"></em>Transmittal Form</a></li>
<li><a href="view_aps_transmittal.php"><em class="fa fa-envelope-open-o"></em>View Transmittal Form</a></li>
<li><a href="annual_dues_payment_form.php"><em class="fa fa-envelope-open-o"></em>Annual Dues Payment Form</a></li>
<li><a href="employees_profile_s.php"><em class="fa fa-envelope-open-o"></em>Employees Payroll Report</a></li>
      </ul>
    </div>
    <section id="main-content" class="column column-offset-20">
            <div class="row grid-responsive mt-1">
        <div class="column">
         <form method="post" action="search_results_cashier.php">
         <input type="text" placeholder="Search Here" name="search_query" class="search_bar">
        </form>
          <div class="card">
              ...
              $query=mysqli_query($con, "SELECT * from members_tb where status!='$status' and status!='$cashier' and status!='$book_keeper' ORDER BY date_of_membership");
              if (! $query) {
                echo mysqli_error($con);
              }
              ?>
              <table id="data_table" class="scroll">
                <thead>
                  <tr>
                  <th>Member Id</th>
    <th>First Name</th>
    ...
    <th>Civil Status</th>
    <th>Gender</th>
    <th>Cuurent School Name</th>
    <th>Current School Address</th>
    <th>Past Position</th>
    <th>Past School Name</th>
    <th>Designation</th>
    ...
    <td><?php echo $row['cur_school_name'] ?></td>
    <td><?php echo $row['cur_school_address'] ?></td>
    <td><?php echo $row['past_position'] ?></td>
    <td><?php echo $row['past_school_name'] ?></td>
    <td><?php echo $row['status'] ?></td>
    <td><?php echo $row['date_of_membership'] ?></td>
