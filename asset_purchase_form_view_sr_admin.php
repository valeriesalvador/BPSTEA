...
<body>
  ...
  <br>
    ...
    <h5 class="mt-2">List of Saved Asset Purchase Forms</h5><a class="anchor" name="tables"></a>
    <form method="post" action="asset_purchase_form_view_sr_admin.php">
...
function str_replace_last( $search , $replace , $str ) {
    ...
    return $str;
              ...
              $query1=mysqli_query($con, "SELECT SUM(payment) as total_payment from asset_purchase_form where payment_purpose LIKE '%$search_query%' or payment LIKE '%$search_query%'")
