  ...
  <br>
   ...
   <li class="dropdown"><a href="javascript:void(0)" class="dropbtn"><em class="fa fa-envelope-open-o"></em>Financial Reports</a>
    <div class="dropdown-content">
     ...
     <h5 class="mt-2">Create Account for Employees</h5><a class="anchor" name="forms"></a>
          <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
           
              <div class="card-block">
              <form method="post" action="create_account_employees_action.php" enctype="multipart/form-data">
                <fieldset>
                  Employee Details<br>
                  <label for="nameField">Designation</label>
                <select name="designation" id="nameField"  required>
                  <option value="Cashier">Cashier</option>
                  <option value="Book Keeper">Book Keeper</option>
                </select>
                    <label for="nameField">Username</label>
                  <input type="text" placeholder="Username" name="username" id="nameField" required="">
                    <label for="nameField">Password</label>
                  <input type="password" placeholder="Password" name="password" id="nameField" required="">
