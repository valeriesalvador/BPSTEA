...
<div class="card-block">
    ...
    <h5 class="mt-2">Asset Purchased Made &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="red">Total Amount:
      <?php
     $date_today=date('Y-m-d');
       $payment_for="Mutual Aid System";
       $status="Approved";
       $query3=mysqli_query($con, "SELECT SUM(payment) as total_amount from asset_purchase_form where date_made='$date_today' and status='$status'");
      ...
      ?>
             ...
             <?php 
              $query=mysqli_query($con, "SELECT * from asset_purchase_form where date_made='$date_today' and status='$status'");
