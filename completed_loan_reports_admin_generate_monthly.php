              ...
              <table class="loan_report" id="data_table">
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ...
                  <tr>
                      ...
                      <?php
                      $status1="Approved";
                      $q=mysqli_query($con, "SELECT SUM(loan_amount) as total_loan_amount, SUM(amortization) as total_interest from loan_tb where status='$status1' and DATE_FORMAT(loan_tb.date_approved, '%Y%m')='$week1'");
