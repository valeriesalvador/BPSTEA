...
<li><a href="view_aps_transmittal.php"><em class="fa fa-envelope-open-o"></em>View Transmittal Form</a></li>
    ...
    <section id="main-content" class="column column-offset-20">
      ...
      <!--Forms-->
      <h5 class="mt-2">Apply for Loan</h5><a class="anchor" name="forms"></a>
      <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
           
              <div class="card-block">
              <form method="post" action="apply_loan_action_c.php">
              
                <fieldset>
                  Loan Details<br>
                    
                  <label for="ageRangeField">Loan Amount</label>
                 <select id="civil_status" name="loan_amount" required="">
                      <option value="10000">PHP 10,000</option>
                    <option value="20000">PHP 20,000</option>
                  </select>
                  <label for="ageRangeField">Years To Pay</label>
                  <select id="gender" name="years_to_pay" required="">
                      <option value="1">1 Year</option>
                   <option value="2">2 Years</option>
                  </select>
                  <br>
                  <input class="button-primary" type="submit" value="Apply for Loan">
                    <a href="member_dashboard.php">Cancel</a>
                </fieldset>
