...
<li><a href="my_annual_dues_ao.php"><em class="fa fa-history"></em>Fees</a></li>
    ...
    <section id="main-content" class="column column-offset-20">
      ...
      <div class="row grid-responsive">
        <div class="column ">
          <a href="my_annual_dues_ao.php">Mutual Aid System</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="membership_fees_ao.php">Membership Fees</a>
          <div class="card">

            <h5 class="mt-2">Annual Dues</h5><a class="anchor" name="tables"></a>
              <div class="card-block">
              <table>
                <thead>
                  <tr>
                    <th>Annual Dues</th>
                      <th>Total Years To Pay</th>
                        <th>Years Left To Pay</th>
                    ...
                    while ($row=mysqli_fetch_array($query)) {
                      ...
                      $membership=$row['membership'];
                        ...
                        <tbody>
                          <tr>
                            <?php
                      $sql1=mysqli_query($con, "SELECT * from annual_dues_tb");
                       if (! $sql1) {
                         echo mysqli_error($con);
                       }
                        while ($row3=mysqli_fetch_array($sql1)) {
                            if ($membership=="Old Member") {
                              ?>
                              <td id="annual_dues"><?php echo "P " . $row3['old_annual_due'] . ".00" ?></td>
                              <?php
                      }elseif ($membership=="New Member") {
                          ?>
                              <td id="annual_dues"><?php echo "P " . $row3['new_annual_due'] . ".00" ?></td>
                              <?php
                      }
                       }
                    ?>
                     <td>
                      ...
                      $sql5=mysqli_query($con, "SELECT * from annual_payment_tb where payment_for='$payment_for'");
                      $years_to_pay1=$years_to_pay - mysqli_num_rows($sql5);
                      echo $years_to_pay1 . " Year(s)";
                       ?>
                     </td>
                     <td>
                      <?php 
                      $sql4=mysqli_query($con, "SELECT max(year) as last_year from annual_payment_tb where employee_number='$user'");
...
?>
  ...
  <script type="text/javascript">
    var mutual_aid_system=document.getElementById("mutual_aid_system");
    var annual_dues=document.getElementById("annual_dues");
    var membership_fee=document.getElementById("membership_fee");
    var total=mutual_aid_system + annual_dues + membership_fee;
