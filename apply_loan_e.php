...
<body>
  <div class="navbar">
   <div class="row">
    <div class="column column-30 col-site-title"><a href="employee_dashboard.php" class="site-title float-left"><img src="logo1.png" class="logo"></a></div>
  ...
  <div class="row">
   ...
   <ul>
         <li><a href="employee_dashboard.php"><em class="fa fa-home"></em>Home</a></li>
        <li><a href="update_details_e.php"><em class="fa fa-id-card"></em>Update Personal Details</a></li>
<li><a href="apply_loan_e.php"><em class="fa fa-money"></em>Apply for Loan</a></li>
<li><a href="my_loans_e.php"><em class="fa fa-history"></em>My Loan(s) History</a></li>
      </ul>
    </div>
      ...
      <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
              ...
              <form method="post" action="apply_loan_action_e.php">
