              ...
              <table>
                <tr class="header" id="haa">
                  <td>
                    ...
                    Statement of Financial Condition As Of <?php echo date('M d, Y') ?>
                  </td>
                </tr>
                <tr>
                  <td>
                    <table>
                      ...
                      <tr>
                       ...
                       $c_total_amount1="";
                        $date=date('Y');
                        $sql=mysqli_query($con, "SELECT SUM(amount) as total_amount from employees_payroll_tb where DATE_FORMAT(payroll_date, '%Y')");
                       ...
                       $l_total_amount="";
                        ...
                        $status="Approved";
                        $status1="Completed";
                        $sql=mysqli_query($con, "SELECT SUM(loan_amount) as total_amount from loan_tb where DATE_FORMAT(date_approved, '%Y') and status='$status' or status='$status1'");
                        while ($row=mysqli_fetch_array($sql)) {
                         ...
                         $query1=mysqli_query($con, "SELECT SUM(payment) as total_amount from asset_purchase_form where DATE_FORMAT(date_made, '%Y')='$year' and status='$status'");
                          $query2=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$year' and payment_for='$payment_for'");
                           $query3=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$year' and payment_for='$payment_for1'");
                            $query4=mysqli_query($con, "SELECT SUM(amount) as total_amount from annual_payment_tb where DATE_FORMAT(year, '%Y')='$year' and payment_for='$payment_for2'");
                               $sql=mysqli_query($con, "SELECT SUM(amount) as total_amount from employees_payroll_tb where DATE_FORMAT(payroll_date, '%Y')");
                               $sql1=mysqli_query($con, "SELECT SUM(loan_amount) as total_amount from loan_tb where DATE_FORMAT(date_approved, '%Y') and status='$status' or status='$status1'");
                                        ...
                                        while ($r4=mysqli_fetch_array($query4)) {
                                          while ($r5=mysqli_fetch_array($sql)) {
                                            while ($r6=mysqli_fetch_array($sql1)) {
                                              $total_amount=$r['total_amount'] + $r1['total_amount']  + $r2['total_amount'] + $r3['total_amount'] + $r4['total_amount'] + $r5['total_amount'] + $r6['total_amount'] + 500;
                                              echo "P" . $total_amount;
                                            }
                                          }
                                        }
                                        ...
                                        while ($r4=mysqli_fetch_array($query4)) {
                                          while ($r5=mysqli_fetch_array($sql)) {
                                            while ($r6=mysqli_fetch_array($sql1)) {
                                              ...
                                              $total_amount=$r['total_amount'] + $r1['total_amount']  + $r2['total_amount'] + $r3['total_amount'] + $r4['total_amount'] + $r5['total_amount'] + $r6['total_amount'] + $r7['total_amount'] + 500;
                                              echo "P" . $total_amount;
                                            }
                                           }
                                          }
