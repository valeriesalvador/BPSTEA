...
<div class="card-block">
    ...
    <h5 class="mt-2">Bills Form &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="red">Total Amount:
      <?php
     $date_today=date('Y-m-d');
       $payment_for="Annual Dues";
       $query4=mysqli_query($con, "SELECT SUM(payment) as total_amount from bills_form_tb where date_made='$date_today'");
      ...
      ?>
             ...
             <?php 
             $query=mysqli_query($con, "SELECT * from bills_form_tb where date_made='$date_today'");
              ?>
              <table>
                <thead>
                  <tr>
