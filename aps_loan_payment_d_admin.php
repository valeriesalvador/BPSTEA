...
<div class="card-block">
    ...
    <h5 class="mt-2">Approved Loans(Automatic Payroll System) &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="red">Total Amount:
      <?php
     $date_today=date('Y-m-d');
       $payment_process="Automatic Payroll System";
       $status="Approved";
       $q="SELECT SUM(loan_tb.loan_amount) as total_amount, SUM(loan_tb.amortization) as total_amount1 from loan_tb INNER JOIN members_tb where loan_tb.employee_number=members_tb.employee_number and members_tb.payment_process='$payment_process' and loan_tb.status='$status' and loan_tb.date_approved='$date_today'";
      $query3=mysqli_query($con, $q);
        while ($row=mysqli_fetch_array($query3)) {
        $total_amount=$row['total_amount'] + $row['total_amount1'];
         echo "P" .$total_amount;
       }
      ?>
    </span>
