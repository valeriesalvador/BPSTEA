              ...
              <table>
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ?>
                    ...
                    <td><a href="view_member_loan.php?id=<?php echo $row['loan_id'] ?>&id1=<?php echo $row['employee_number'] ?>"><?php echo $row['employee_number'] ?></a></td>
...
?>
                     ...
                     <td>
                      <a href="accept.php?id=<?php echo $row['loan_id'] ?>">Approve</a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="decline.php?id=<?php echo $row['loan_id'] ?>">Decline</a> 
                     </td>
