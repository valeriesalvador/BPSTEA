...
<li><a href="annual_dues_payment_form.php"><em class="fa fa-envelope-open-o"></em>Annual Dues Payment Form</a></li>
    ...
    <section id="main-content" class="column column-offset-20">
      ...
      <!--Forms-->
      <h5 class="mt-2">Bills Form</h5><a class="anchor" name="forms"></a> <a href="bills_form_view.php">View Saved Bills Form</a>
      <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
           
              <div class="card-block">
              <form method="post" action="bills_form_action.php">
              
                <fieldset>
                Bills Form Details<br>
                   
                   <label for="nameField">Payment:</label>
                  <input type="number" placeholder="Payment Amount" name="payment" id="nameField" required="">
                    <label for="nameField">Payment For:</label>
                  <input type="text" placeholder="Payment For" name="payment_for" id="nameField" required="">
                  
                  <br>
                  <input class="button-primary" type="submit" value="Save Bill Form">
