...
<li><a href="my_annual_dues_m.php"><em class="fa fa-history"></em>Fees</a></li>
      </ul>
    </div>
    <section id="main-content" class="column column-offset-20">
      ...
      <div class="row grid-responsive">
        <div class="column ">
          <a href="my_annual_dues_m.php">Mutual Aid System</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="membership_fees_m.php">Membership Fees</a>
          <div class="card">
