...
<body>
  ...
  <br>
   ...
   <li class="dropdown"><a href="javascript:void(0)" class="dropbtn"><em class="fa fa-envelope-open-o"></em>Financial Reports</a>
    ...
    <h5 class="mt-2">List of Not Verified Members</h5><a class="anchor" name="tables"></a>
     <form method="post" action="approve_reg_sr.php">
          <input type="text" placeholder="Search By Member Id/Name/School Name/Home Address" name="search_query">
        </form>
        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block">
              ...
              $status="Not Verified";
              $query=mysqli_query($con, "SELECT * from members_tb where status='$status' and employee_number LIKE '%$search_query%' or first_name LIKE '%$search_query%' or middle_name LIKE '%$search_query%' or last_name LIKE '%$search_query%' or cur_school_name LIKE '%$search_query%' or address LIKE '%$search_query%' ORDER BY date_of_membership");
              ?>
              <table>
                <thead>
                  <tr>
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ?>
                     <tr>
                    <td><a href="change_designation.php?id=<?php echo $row['employee_number'] ?>"><?php echo $row['status']; ?></a></td>
                    <td><?php echo $row['employee_number']; ?></td>
                    <td><?php echo $row['first_name'] . " " . $row['middle_name'] . " " . $row['last_name']; ?></td>
                    <td><?php echo $row['address']; ?></td>
                    <td><?php echo $row['birthday']; ?></td>
                     <td><?php echo $row['contact_number']; ?></td>
                     <td><a href="view_more_details_nv.php?id=<?php echo $row['employee_number'] ?>">View More Details</a></td>
