...
<body>
  <div class="navbar">
   <div class="row">
      <div class="column column-30 col-site-title"><a href="index.php" class="site-title float-left"><img src="logo1.png" class="logo"></a></div>
  ...
  <div class="row">
    ...
    <ul>
        <li><a href="about_us_index.php"><em class="fa fa-home"></em>About Us</a></li>
        <li><a href="contact_us_index.php"><em class="fa fa-phone"></em>Contact Us</a></li>
    ...
    <section id="main-content" class="column column-offset-20">
      ...
      <!--Forms-->
      <h5 class="mt-2">Add Beneficiary to Finish Registration</h5><a class="anchor" name="forms"></a>
        ...
        <div class="column ">
          <div class="card">
            <div class="card-title">
              ...
              <form method="post" action="add_beneficiary_action.php" enctype="multipart/form-data">
                <fieldset>
                  ...
                  <input type="hidden" name="employee_number" value="<?php echo $_GET['id'] ?>">
                  <br>
  ...
  <script type="text/javascript">
    $('input[name="emp_number"]').keypress(function() {
