...
<div class="card-block">
    ...
    <h5 class="mt-2">Annual Dues Payments Today &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span class="red">Total Amount:
      <?php
      ...
      ?>
              ...
              <table class="loan_report">
                ...
                <tbody>
                  ...
                  $query2=mysqli_query($con, "SELECT * from annual_payment_tb where year='$date_today' and payment_for='$payment_for'");
                while ($row=mysqli_fetch_array($query2)) {
                  ?>
                     <tr>
                    <td><?php echo $row['year'] ?></td>
                       <td><?php echo $row['employee_number'] ?></td>
                    <td><?php echo "P" . $row['amount'] ?></td>
