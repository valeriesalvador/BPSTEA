...
input[value="One Time Payment"]:checked ~ #one_time{
  display: block;
}
input[value="Installment"]:checked ~ #installment{
  display: block;
}
a.dropbtn {
    display: inline-block;
...
<li><a href="employees_profile_s.php"><em class="fa fa-envelope-open-o"></em>Employees Payroll Report</a></li>
    ...
    <section id="main-content" class="column column-offset-20">
      ...
      <!--Forms-->
      <h5 class="mt-2">Asset Purchase Form</h5><a class="anchor" name="forms"></a> <a href="asset_purchase_form_view.php">View Saved Asset Purchase Form</a>
      <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
           
              <div class="card-block">
              <form method="post" action="asset_purchase_form_action.php">
              
                <fieldset>
               Asset Purchase Details<br>
                   <label for="nameField">Payment Type:</label>
                  <input type="radio" name="payment_type" value="One Time Payment" required>One Time Payment<br>
                  <input type="radio" name="payment_type" value="Installment" required>Installment<br>
                   <label for="nameField">Payment For:</label>
                  <input type="text" placeholder="Payment For" name="payment_for" id="nameField" required="">
                  <label for="nameField">Asset Name:</label>
                    <input type="text" placeholder="Name of Object" name="name_of_object" id="nameField" required="">
                  
                   <label for="nameField">Quantity:</label>
                  <input type="number" placeholder="Quantity" name="quantity" id="nameField">
                   <label for="nameField">Unit Price:</label>
                  <input type="text" placeholder="Unit Price" name="unit_price" id="nameField">
                   <label for="nameField">Purchased From:</label>
                  <input type="text" placeholder="Purchased From" name="purchased_from" id="nameField">
                   <label for="nameField">Date Purchased:</label>
                  <input type="date" name="purchased_date" id="nameField">
                  
                  <div class="one_time" id="one_time">
                    <label for="nameField">Cash Payment</label>
                    <input type="text" name="cash_payment" placeholder="Cash Payment" value="-">
                  </div>
                  <div class="installment" id="installment">
                   <label for="nameField">Years to Pay</label>
                  <input type="number" placeholder="Years to Pay" name="years_to_pay" value="-" id="nameField">
                  <label for="nameField">Monthly Payment:</label>
                  <input type="number" placeholder="Monthly Payment" name="monthly_payment" value="-" id="nameField">
                  </div>

                  <br>
                  <input class="button-primary" type="submit" value="Save Asset Purchase Form">
