...
<li><a href="reg_members_bk.php"><em class="fa fa-address-book-o"></em>Member's Details and Transaction History</a></li>
 <li class="dropdown"><a href="javascript:void(0)" class="dropbtn"><em class="fa fa-envelope-open-o"></em>Forms</a>
    <div class="dropdown-content">
      <a href="or_p_bk.php"><em class="fa fa-envelope-open-o"></em>Official Receipts Form</a>
       <a href="bills_form_bk.php"><em class="fa fa-envelope-open-o"></em>Bills Form</a>
      <a href="asset_purchase_form_bk.php"><em class="fa fa-envelope-open-o"></em>Asset Purchase Form</a>
    </div>
  </li>
