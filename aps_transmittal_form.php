...
<li><a href="annual_dues_payment_form.php"><em class="fa fa-envelope-open-o"></em>Annual Dues Payment Form</a></li>
    ...
    <section id="main-content" class="column column-offset-20">
       <h5 class="mt-2">Transmittal Form</h5><a class="anchor" name="forms"></a>
        ...
        <div class="column ">
          <div class="card">
              ...
              <div class="card-block">
               <?php
               $loan_id=$_GET['id'];
               $query=mysqli_query($con, "SELECT * from loan_tb where loan_id='$loan_id'");
               while ($row=mysqli_fetch_array($query)) {
                  $employee_number1=$row['employee_number'];
                  $query1=mysqli_query($con, "SELECT * from members_tb where employee_number='$employee_number1'");
                  while ($row1=mysqli_fetch_array($query1)) {
                    ?>
                     <form method="post" action="transmittal_action.php">
              
                <fieldset>
                  <label for="nameField">Region:</label>
                  <input type="text" placeholder="Region" name="region" value="III" id="nameField" required="">
                  <br>
                  <label for="nameField">Division Number:</label>
                  <input type="text" placeholder="Division Number" name="division_number" id="nameField" required="">
                  <br>
                   <label for="nameField">Station Code:</label>
                  <input type="text" placeholder="Station Code" name="station_code" id="nameField" required="">
                  <br>
                   <label for="nameField">Member Id:</label>
                  <input type="text" placeholder="Member Id" name="employee_number" value="<?php echo $employee_number1 ?>" id="nameField" required="">
                  <br>
                   <label for="nameField">Policy Number:</label>
                  <input type="text" placeholder="Policy Number" name="policy_number" id="nameField" required="">
                  <br>
                   <label for="nameField">Name:</label>
                  <input type="text" placeholder="Name" value="<?php echo $row1['first_name'] . " " . $row1['last_name'] ?>" name="name" id="nameField" required="">
                  <br>
                   <label for="nameField">Deduction Code:</label>
                  <input type="text" placeholder="Deduction Code" name="deduction_code" id="nameField" required="">
                  <br>
                   <label for="nameField">Loan Amount:</label>
                  <input type="text" placeholder="Loan Amount" value="<?php echo $row['loan_amount'] ?>" name="loan_amount" id="nameField" required="">
                  <br>
                   <label for="nameField">Term:</label>
                  <input type="text" placeholder="Term" name="term" value="<?php echo $row['years_to_pay'] . " Year(s)" ?>" id="nameField" required="">
                  <br>
                   <label for="nameField">Effectivity Date:</label>
                  <input type="date" name="effectivity_date" value="<?php echo $row['date_approved'] ?>" id="nameField" required="">
                  <br>
                    <label for="nameField">Termination Date:</label>
                  <input type="date" name="termination_date" value="<?php
...
echo date_format($date,"Y-m-d");
                  ...
                  <br>
                  <label for="nameField">Monthly Amortization:</label>
                  <input type="text" placeholder="Monthly Amortization" value="<?php echo $row['amortization'] ?>" name="monthly_amortization" id="nameField" required="">
                  <br>
                  <label for="nameField">Remarks:</label>
                  <input type="text" placeholder="Remarks" name="remarks" id="nameField" required="">
                  <br>
                  <input class="button-primary" type="submit" value="Save Transmittal Form">
