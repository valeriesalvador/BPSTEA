...
<body>
  ...
  <li><a href="approve_reg.php"><em class="fa fa-thumbs-o-up"></em>Approve Registration Requests</a></li>
    ...
    <h5 class="mt-2">List of Registered Members</h5><a class="anchor" name="tables"></a>
    <form method="post" action="assign_designation_sr.php">
        ...
        <div class="column ">
          <div class="card">
            ...
            <div class="card-block">
              ...
              $query=mysqli_query($con, "SELECT * from members_tb where employee_number LIKE '%$search_query%' or first_name LIKE '%$search_query%' or middle_name LIKE '%$search_query%' or last_name LIKE '%$search_query%' or cur_school_name LIKE '%$search_query%' or address LIKE '%$search_query%' ORDER BY date_of_membership");
              ?>
              <table>
                <thead>
                  <tr>
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ?>
                    ...
                    <td><?php echo $row['birthday']; ?></td>
                     ...
                     <td><a href="view_more_details.php?id=<?php echo $row['employee_number'] ?>">View More Details</a></td>
