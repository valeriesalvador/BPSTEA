...
<body>
	<div class="navbar">
		<div class="row">
		<div class="row">
      <div class="column column-30 col-site-title"><a href="president_dashboard.php" class="site-title float-left"><img src="logo1.png" class="logo"></a></div>
   ...
   <ul>
        <li><a href="bills_form_view_president.php"><em class="fa fa-handshake-o">View Bills Form</em></a></li>
  <li><a href="asset_purchase_form_view_president.php"><em class="fa fa-thumbs-o-up"></em>View Asset Purchase Form</a></li>
   <li><a href="approve_asset_purchase_form.php"><em class="fa fa-envelope-open-o"></em>Approve Asset Purchase Request</a></li>
           <li><a href="approve_approval_officer_loan.php"><em class="fa fa-envelope-open-o"></em>Approve Approval Officer's Loan Request</a></li>
            <li><a href="loan_reports_president.php"><em class="fa fa-envelope-open-o"></em>Loan Status</a></li>
      </ul>
    </div>
    <section id="main-content" class="column column-offset-20">
    <h5 class="mt-2">Requests for Loans</h5><a class="anchor" name="tables"></a>
          ...
          <div class="card">
            ...
            <div class="card-block">
              <?php 
               $user=$_SESSION['user'];
               $status="Not Approved";
               $member_status="Approving Officer";
              $query=mysqli_query($con, "SELECT loan_tb.loan_id, loan_tb.employee_number, loan_tb.loan_amount, loan_tb.years_to_pay, loan_tb.date_applied, members_tb.employee_number, loan_tb.status from loan_tb INNER JOIN members_tb where loan_tb.employee_number=members_tb.employee_number and members_tb.status='$member_status' and loan_tb.status='$status'");
              ...
              <table>
                ...
                while ($row=mysqli_fetch_array($query)) {
                  ?>
                    ...
                    <td><a href="view_member_loan_president.php?id=<?php echo $row['loan_id'] ?>&id1=<?php echo $row['employee_number'] ?>"><?php echo $row['employee_number'] ?></a></td>
                    ...
                    <td><?php echo $row['years_to_pay'] . " Year(s)"; ?></td>
                     ...
                     if ($row['status']=="Approved") {
                       ?>
                         <div class="alert background-success"></em> <?php echo $row['status'] ?></div>
                       <?php
                     }elseif ($row['status']=="Not Approved") {
                      ?>
                       <div class="alert background-danger"><?php echo $row['status'] ?></div>
                       <?php
                     }elseif ($row['status']=="Done Paying") {
                      ?>
                       <div class="alert"><em class="fa fa-bullhorn"><?php echo $row['status'] ?></div>
                       <?php
                     }elseif ($row['status']=="Pending") {
                      ?>
                       <div class="alert background-warning"><em class="fa fa-warning"><?php echo $row['status'] ?></div>
                       <?php
                     }
?>
                     </td>
                     <td>
                      <a href="accept_president.php?id=<?php echo $row['loan_id'] ?>">Approve</a> &nbsp;&nbsp;&nbsp;&nbsp;<a href="decline_president.php?id=<?php echo $row['loan_id'] ?>">Decline</a> 
                     </td>
