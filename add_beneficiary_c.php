...
<body>
  ...
  <div class="row">
   ...
   <ul>
        ...
        <li><a href="update_details_c.php"><em class="fa fa-id-card"></em>Update Personal Details</a></li>
<li><a href="apply_loan_c.php"><em class="fa fa-money"></em>Apply for Loan</a></li>
<li><a href="my_loans_c.php"><em class="fa fa-history"></em>My Loan(s) History</a></li>
...
<li><a href="reg_members_c.php"><em class="fa fa-address-book-o"></em>View Member's Details and Transaction History</a></li>
...
<li><a href="asset_purchase_form.php"><em class="fa fa-envelope-open-o"></em>Asset Purchase Form</a></li>
    ...
    <section id="main-content" class="column column-offset-20">
       <h5 class="mt-2">Add Beneficiary</h5><a class="anchor" name="forms"></a>
          <div class="row grid-responsive">
        <div class="column ">
          <div class="card">
           
              <div class="card-block">
              <form method="post" action="add_beneficiary_action_c.php" enctype="multipart/form-data">
                <fieldset>
                  Beneficiary Information<br>
                  <label for="nameField">Full Name of Beneficiary</label>
                  <input type="text" placeholder="Full Name of Beneficiary" name="full_name" id="txtF" required="">
                    <label for="nameField">Address</label>
                  <input type="text" placeholder="Address" name="address" id="nameField" required="">
                    <label for="nameField">Contact Number</label>
                  <input type="text" placeholder="Contact Number" name="contact_number" id="nameField" required="">
                    <label for="nameField">Age</label>
                  <input type="text" placeholder="Age" name="age" id="nameField" required="">
                    <label for="nameField">Occupation</label>
                  <input type="text" placeholder="Occupation" name="occupation" id="nameField" required="">
                   <label for="nameField">Relationship</label>
                  <input type="text" placeholder="Relationship" name="relationship" id="nameField" required="">
                  <br>
                  <input class="button-primary" type="submit" value="Save Beneficiary">
                </fieldset>
              </form>
            </div>
          </div>
